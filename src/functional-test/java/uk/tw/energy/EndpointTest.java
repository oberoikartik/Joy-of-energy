...
public class EndpointTest {
    ...
    public void givenMeterIdShouldReturnAMeterReadingAssociatedWithMeterId() throws JsonProcessingException {
        ...
        ResponseEntity<String> response = restTemplate.getForEntity("/readings/" + smartMeterId, String.class);
    ...
    public void shouldCalculateAllPrices() throws JsonProcessingException {
        ...
        ResponseEntity<String> response = restTemplate.getForEntity("/price-plans/comparisons/" + smartMeterId, String.class);
    ...
    public void givenMeterIdAndLimitShouldReturnRecommendedCheapestPricePlans() throws JsonProcessingException {
        ...
        ResponseEntity<String> response =
                restTemplate.getForEntity("/price-plans/recommendations/" + smartMeterId + "?limit=2", String.class);
        assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    }
